      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="flex items-center text-gray-600"><Clock className="w-5 h-5 mr-2 text-teal-600" /> Sat: 9am - 5pm</p>
              <p className="flex items-center text-gray-600"><Clock className="w-5 h-5 mr-2 text-teal-600" color='red'/> Sun: Closed</p>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-500">
            © {new Date().getFullYear()} Mella Counseling. All rights reserved.
          </p>
          <p className="text-center text-gray-500 flex justify-center items-center space-x-1">
            <span>Made by</span>
            <span className="text-teal-600 font-semibold">MoTech Solutions</span>
